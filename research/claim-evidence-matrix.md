...
record and both failed exit audits are preserved. The post-audit candidate has
71 M3 integration/security tests inside a 325-test cumulative run, plus focused
attestation and governance coverage. All 317 prior candidate node IDs remain and
eight new IDs are listed in the report. These are engineering tests, not
benchmark observations or empirical support for TER, PIP, BSR, C2-C5, baseline
advantage, or cross-Agent generality. The M3 human exit gate remains pending a
new independent read-only audit.
