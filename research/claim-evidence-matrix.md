...
technical exit audit at `2294af3` passes; the M3 human exit gate remains pending.
...
advantage or cross-agent results. M3's technical reaudit passes, but the human
exit gate remains open; M4 has not started.
